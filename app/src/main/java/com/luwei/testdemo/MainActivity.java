...
import com.luwei.testdemo.adapter.SlidingPagerAdapter;
import com.luwei.testdemo.fragment.ScrollTabHolder;
import com.luwei.testdemo.sliding.PagerSlidingTabStrip;
...
public class MainActivity extends ActionBarActivity implements OnPageChangeListener, ScrollTabHolder {
	...
	private void findViews() {
		...
		kanner = header.findViewById(R.id.show_event_detail_bg);
